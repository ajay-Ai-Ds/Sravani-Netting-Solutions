    ...
    <>
      ...
      <div className="fixed bottom-24 right-5 z-40 flex flex-col space-y-3 items-end">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.9 }}
          className="flex items-center justify-center w-14 h-14 bg-[#e63946] hover:bg-[#dc2626] text-white rounded-full shadow-lg cursor-pointer transition-colors duration-200 animate-pulse-subtle relative group border border-white/20"
      ...
      <div className="sm:hidden fixed bottom-0 left-0 w-full bg-[#e63946] border-t border-[#dc2626] shadow-[0_-4px_12px_rgba(0,0,0,0.15)] grid grid-cols-2 p-3 gap-3 z-50">
        <a
          href="tel:+918637607910"
          className="flex items-center justify-center space-x-2 bg-[#dc2626] hover:bg-[#b91c1c] text-white py-3.5 px-4 rounded-xl text-base font-bold active:scale-95 transition-transform min-h-[48px] border border-white/20"
        >
