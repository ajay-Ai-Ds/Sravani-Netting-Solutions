    ...
    <>
      ...
      <div className="sm:hidden fixed bottom-0 left-0 w-full bg-slate-900/95 backdrop-blur-xl border-t border-slate-800 shadow-[0_-4px_20px_rgba(0,0,0,0.3)] grid grid-cols-2 p-3 gap-3 z-50">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center space-x-2 bg-[#25D366] hover:bg-[#1DA851] text-white py-3.5 px-4 rounded-xl text-base font-bold active:scale-95 transition-transform min-h-[48px] border border-[#25D366] shadow-md"
        >
