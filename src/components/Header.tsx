          ...
          <div className="flex items-center justify-between h-[50px]">
            ...
            <div className="flex items-center space-x-2.5">
              ...
              <a
                ...
                className="hidden xl:flex items-center space-x-1.5 bg-[#000000] hover:bg-[#1a1a1a] text-white px-3.5 py-2.5 rounded-xl text-xs font-extrabold shadow-md transition-all duration-200 hover:shadow-lg active:scale-95 border border-[#000000] whitespace-nowrap"
              >
            ...
            <div className="bg-white border border-[#e5e5e5] shadow-2xl rounded-2xl overflow-hidden p-5 space-y-4 text-[#000000]">
              ...
              <div className="grid grid-cols-2 gap-3 pt-3 border-t border-[#e5e5e5]">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center space-x-2 bg-[#000000] hover:bg-[#1a1a1a] text-white py-3.5 rounded-xl text-sm font-bold shadow-md transition-all active:scale-98 border border-[#000000]"
                >
