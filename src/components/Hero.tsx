          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="min-h-[36px] sm:min-h-[40px] flex items-center">
              <motion.span
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1 sm:px-4 sm:py-1.5 rounded-full text-xs sm:text-sm font-extrabold uppercase tracking-wider bg-secondary text-white shadow-md whitespace-nowrap"
              >
                  ...
                  >
                    <span
                      className={`h-2 rounded-full transition-all duration-300 ${
                        currentSlide === index ? "bg-secondary w-7" : "bg-white/40 w-2 group-hover:bg-white/60"
                      }`}
                    />
                  </button>
                ))}
                ...
                <form onSubmit={handleSubmit} className="space-y-3.5">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    <a
                      ...
                      className="flex items-center justify-center space-x-1.5 bg-accent hover:bg-accent-dark text-white py-2 rounded-lg text-xs font-semibold border border-white/10 transition-colors"
                    >
          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <a
                  href="tel:+918637607910"
                  className="flex items-center justify-center space-x-1.5 bg-accent hover:bg-accent-dark text-white py-2.5 rounded-lg text-xs font-semibold border border-white/10 transition-colors"
                >
                  <Phone className="w-3.5 h-3.5 fill-white" />
                  <span>Call Now</span>
                </a>
